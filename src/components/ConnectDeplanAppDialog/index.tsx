...
import { connectDeplanWalletFrameSrc, connectDeplanWalletOrigin } from '../../constants/connect-deplan-wallet-frame-src'
    ...
    return (
        <>
            <dialog ref={dialogRef} id="connect-deplan-app">
                <iframe
                    id='deplan-iframe'
                    style={{ width: `auto`, height: `${iframeSize.height}px`, border: 'none', background: 'transparent', borderRadius: 'clamp(0px, calc(4px * 9), 44px)' }}
                    ref={iframeRef}
